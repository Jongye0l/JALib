...
public static class ByteTools {
    ...
    public static byte[] ToBytes(this object value, bool declearing = false, bool includeClass = false, uint? version = null, bool nullable = true) {
        using MemoryStream output = new();
        ToBytes(value, output, declearing, includeClass, version, nullable);
