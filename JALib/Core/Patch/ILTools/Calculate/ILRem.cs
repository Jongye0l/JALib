...
public class ILRem : ILCalculate {

    public ILRem(ILCode left, ILCode right) : base(left, right) {
    ...
    public override IEnumerable<CodeInstruction> Load(ILGenerator generator) {
        ...
        yield return new CodeInstruction(ReturnType.IsUnsigned() ? OpCodes.Rem_Un : OpCodes.Rem);
    }
